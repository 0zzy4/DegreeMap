  ...
  return (
    <div className="bg-white rounded-lg shadow p-6 mb-8"> {/* Semester Grid Container */}
      ...
      <div className="flex flex-col">
        <Year year="Year 1" courses={courses} onAddCourse={onAddCourse} />
        <Year year="Year 2" courses={courses} onAddCourse={onAddCourse} />
        <Year year="Year 3" courses={courses} onAddCourse={onAddCourse} />
        <Year year="Year 4" courses={courses} onAddCourse={onAddCourse} />
      </div>
