  ...
  return (
    <div className="border border-gray-300 rounded-lg mt-4"> {/* Year Container */}
      ...
      <div className="grid grid-cols-3">
        <Semester courses={courses} onAddCourse={onAddCourse} semester="Fall" />
        <Semester courses={courses} onAddCourse={onAddCourse} semester="Spring" />
        <Semester courses={courses} onAddCourse={onAddCourse} semester="Summer" />
      </div>
